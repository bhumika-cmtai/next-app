...
const PrivacyPolicyPage = () => {
  return (
    <>
      <Head>
        <title>Privacy Policy - GROW UP</title>
        <meta
          name="description"
          content="Learn how GROW UP collects, uses, and protects your personal information. Your trust and privacy are our top priority."
        />
      </Head>
        ...
        <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
          ...
          <div className="mt-16 space-y-12">
            ...
            <section>
              ...
              <p className="mt-6">
                Welcome to GROW UP! Our mission, envisioned by our founders Mr. Gaurav Prajapati and Ms. Priya Verma, is to build a better future for all Indians by providing easy, secure, and genuine work-from-home opportunities. This Privacy Policy explains how we collect, use, share, and protect your personal information when you use our website and services (collectively, our "Platform").
              </p>
            </section>
