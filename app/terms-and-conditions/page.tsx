...
const TermsAndConditionsPage = () => {
  return (
    <>
      <Head>
        <title>Terms and Conditions - GROW UP</title>
        <meta
          name="description"
          content="Review the Terms and Conditions for using the GROW UP platform. Understand your rights and responsibilities as a user."
        />
      </Head>
      ...
      <div className="bg-white px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
          ...
          <p className="mt-6 text-xl leading-8">
            Welcome to GROW UP. These Terms and Conditions ("Terms") govern your use of our website and services. By accessing or using our Platform, you agree to be bound by these Terms and our Privacy Policy.
          </p>
          ...
          <div className="mt-16 space-y-12">
            ...
            <section>
              ...
              <p className="mt-6">
                GROW UP ("we," "us," or "our") provides an online platform that connects individuals ("Users," "you," "your") with genuine, verified work-from-home tasks and opportunities ("Work," "Tasks") offered by third-party companies ("Clients"). Our role is to act as a facilitator, creating an ecosystem that matches skills with meaningful work.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-6">
                As a user of GROW UP, you agree to:
              </p>
              <ul role="list" className="mt-8 space-y-4">
            ...
            <section>
              ...
              <p className="mt-6">
                This is a critical distinction. By using our Platform, you acknowledge and agree that you are an <strong>independent contractor</strong>, not an employee, agent, partner, or joint venturer of GROW UP or its Clients. You are not eligible for any employee benefits, and you are responsible for your own tools, equipment, and work environment.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-6">
                The Platform is provided on an "as-is" and "as-available" basis. While we strive to provide authentic and consistent work, we do not guarantee a continuous supply of Tasks or a specific level of income. To the fullest extent permitted by law, GROW UP shall not be liable for any indirect, incidental, or consequential damages arising out of your use of the Platform.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="mt-6">
                ...
                <p><strong>Website:</strong> <Link href="https://grow-up-fe.vercel.app/" className="text-purple-600 hover:text-purple-700 hover:underline">Grow Up</Link></p>
              </div>
            </section>
